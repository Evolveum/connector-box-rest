 ...
 *
 */
public class BoxConnectorConfiguration extends AbstractConfiguration implements StatefulConfiguration, ConfigurationForResultsHandler{
	...
	public void setEnableAttributesToGetSearchResultsHandler(boolean enableAttributesToGetSearchResultsHandler) {
		LOGGER.info("I AM SETTING AttributesToGetSearchResultsHandler : {0}", String.valueOf(enableAttributesToGetSearchResultsHandler));
	...
	public void setFilteredResultsHandlerInValidationMode(boolean filteredResultsHandlerInValidationMode) {
		LOGGER.info("I AM SETTING FilteredResultsHandlerInValidationMode : {0}", String.valueOf(filteredResultsHandlerInValidationMode));
